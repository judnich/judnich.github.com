...
(function() {
  ...
  root.Starfield = (function() {
    ...
    function Starfield(_arg) {
      var angle, blockMaxStars, blockMinStars, blockScale, buff, i, j, k, marker, pos, randAngle, randomStream, starSize, u, v, vi, viewRange, w, x, y, z, _i, _j, _k, _l, _ref, _ref1, _ref2, _ref3, _ref4;
    ...
    Starfield.prototype.queryStars = function(position, originOffset, radius, maxStars) {};

    Starfield.prototype.render = function(camera, originOffset, blur) {
      var bpos, ci, cj, ck, i, j, k, minDist, oi, oj, ok, r, randStream, seed, x, y, z, _i, _j, _k, _ref, _ref1, _ref2;
      this._startRender();
      this.blur = blur;
      ...
      _ref1 = [ci - originOffset[0] / this.blockScale, cj - originOffset[1] / this.blockScale, ck - originOffset[2] / this.blockScale], oi = _ref1[0], oj = _ref1[1], ok = _ref1[2];
      ...
      for (i = _i = -r; -r <= +r ? _i <= +r : _i >= +r; i = -r <= +r ? ++_i : --_i) {
        for (j = _j = -r; -r <= +r ? _j <= +r : _j >= +r; j = -r <= +r ? ++_j : --_j) {
          for (k = _k = -r; -r <= +r ? _k <= +r : _k >= +r; k = -r <= +r ? ++_k : --_k) {
            _ref2 = [i + oi, j + oj, k + ok], x = _ref2[0], y = _ref2[1], z = _ref2[2];
            ...
            if (minDist <= this.viewRange) {
              ...
              this._renderBlock(camera, seed, randStream.range(this.blockMinStars, this.blockMaxStars), x, y, z);
            }
          }
        }
      }
